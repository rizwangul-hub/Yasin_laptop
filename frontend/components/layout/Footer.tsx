        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 flex items-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-900 hover:bg-slate-800 border border-slate-700/80 text-white text-xs font-semibold transition-all hover:scale-105"
              >
                {/* TikTok SVG */}
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm">
              <li>
                <Link href="/laptops?category=business-laptops" className="hover:text-white transition-colors">
                  Business Laptops
                </Link>
              </li>
              <li>
                <Link href="/laptops?category=student-budget-laptops" className="hover:text-white transition-colors">
                  Student &amp; Budget Laptops
                </Link>
              </li>
              <li>
                <Link href="/laptops?category=chromebooks" className="hover:text-white transition-colors">
                  Chromebooks
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-emerald-400 font-medium">WhatsApp: +92 342 7709129</span>
              </div>
            </div>
          </div>
        </div>
