    ...
    <Card className="flex flex-col h-full overflow-hidden bg-white border border-charcoal-200/90 shadow-soft p-0 rounded-3xl">
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-4">
        <div className="space-y-2">
          <Skeleton className="h-4 w-3/4 bg-charcoal-200" />
          <Skeleton className="h-3 w-full bg-charcoal-100" />
          <Skeleton className="h-3 w-2/3 bg-charcoal-100" />
        </div>
        <div className="pt-3 border-t border-charcoal-100 space-y-3">
          <Skeleton className="h-6 w-24 bg-charcoal-200" />
